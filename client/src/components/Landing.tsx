  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-purple-100 text-gray-900 flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-[1150px] mx-auto flex items-center justify-center">
          <div className="w-full flex flex-col md:flex-row gap-8 items-stretch justify-center">
            <div className="bg-white rounded-2xl shadow-xl p-6 flex-1 max-w-[540px] flex flex-col justify-center items-start min-w-0 border mx-auto">
              <div className="w-full">
